...
class BiSeNet(nn.Module):
    def __init__(self, n_classes, *args, **kwargs):
        ...
        self.conv1 = ConvINSiLU(256, 256, ks=3, stride=1, padding=2, dilation=2)
        # self.conv2 = ConvINSiLU(128, 64, ks=3, stride=1, padding=2, dilation=2)
        self.conv3 = nn.Conv2d(256, n_classes, kernel_size=1, bias=False)
